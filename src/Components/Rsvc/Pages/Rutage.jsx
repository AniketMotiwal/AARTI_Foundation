...
import React from "react";
import image1 from "../../../assets/Air Coling  Based Vending Cart.jpg";
import image2 from "../../../assets/Bagheswari Wool Charka.jpg";
import image3 from "../../../assets/picohydro.jpg";

const ImageGallery = () => {
  const images = [
    {
      title: "Air Cooling Based Vending Cart",
      src: image1,
    },
    {
      title: "Pico Hydro (Watermill) Based Cold Storage and Other Livelihood Activities",
      src: image2,
    },
    {
      title: "Variable Speed Solar Based Bagheshwari Wool Charkha",
      src: image3,
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold text-center mb-8">Some Technologies at RSVC Almora</h2>
      <p className="text-center text-lg text-gray-600 mb-6">Innovative solutions for sustainable development and livelihood enhancement.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {images.map((image, index) => (
          <div 
            key={index}
            className={`relative group overflow-hidden rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl h-64`}
          >
            <img
              src={image.src}
              alt={image.title}
